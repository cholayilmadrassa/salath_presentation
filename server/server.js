...
const corsOptions = {
  ...
  credentials: true,
  allowedHeaders: ['Content-Type', 'Authorization', 'Cache-Control', 'Pragma', 'cache-control', 'pragma', 'x-tenant-id', 'x-tenant-slug', 'x-tenant-host', 'x-forwarded-host', 'Accept', 'Origin'],
};
