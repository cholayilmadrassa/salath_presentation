...
/** Skeleton placeholder for a single leaderboard row */
function LeaderboardSkeletonRow() {
  return (
    <div className="bg-card rounded-2xl p-3.5 shadow-xs flex items-center justify-between border border-border animate-pulse">
      {/* Left: Avatar + text lines */}
